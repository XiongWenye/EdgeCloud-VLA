...
Evaluation must use the installed `lerobot_policy_cloudedge_pi05` plugin. Reported result tables, exact artifact revisions, and code commit should be uploaded with the checkpoint after completion. This model should not be used for safety-critical or unsupervised physical robot control.
